...
const Page = ({ params }: { params: { teamId: string } }) => {
    ...
    const [teamDetails, setTeamDetails] = useState<any>(null); // To hold team and owner info
    ...
    const handleAcceptInvite = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post(`${CORE_SERVICE_API}/team-members/accept-invite`, { token: invite_token });
                    ...
                    <CardContent>
                        {teamDetails && !success && !error ? (
                            ...
                            <p className="text-center text-green-500">
                                Congrats! Your are now a member of {teamDetails.team.name}.
                            </p>
                        ) : error ? (
